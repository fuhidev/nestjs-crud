...
<div align="center">
  ...
  <a href="https://www.npmjs.com/package/@fuhidev/crud">
    <img src="https://img.shields.io/npm/v/@fuhidev/crud.svg" alt="npm version" />
  </a>
  <a href="https://www.npmjs.com/org/nestjsx">
    <img src="https://img.shields.io/npm/dm/@fuhidev/crud.svg" alt="npm downloads" />
  </a>
  <a href="https://npm.packagequality.com/#?package=@fuhidev%2Fcrud">
...
We believe that everyone who's working with NestJs and building some RESTful services and especially some CRUD functionality will find `@fuhidev/crud` microframework very useful.
...
```shell
npm i @fuhidev/crud class-transformer class-validator
```

## Packages

- [**@fuhidev/crud**](https://www.npmjs.com/package/@fuhidev/crud) - core package which provides `@Crud()` decorator for endpoints generation, global configuration, validation, helper decorators ([docs](https://github.com/nestjsx/crud/wiki/Controllers#description))
- [**@fuhidev/crud-request**](https://www.npmjs.com/package/@fuhidev/crud-request) - request builder/parser package which provides `RequestQueryBuilder` class for a frontend usage and `RequestQueryParser` that is being used internally for handling and validating query/path params on a backend side ([docs](https://github.com/nestjsx/crud/wiki/Requests#frontend-usage))
- [**@fuhidev/crud-typeorm**](https://www.npmjs.com/package/@fuhidev/crud-typeorm) - TypeORM package which provides base `TypeOrmCrudService` with methods for CRUD database operations ([docs](https://github.com/nestjsx/crud/wiki/ServiceTypeorm))
